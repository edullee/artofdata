...
---
The [Palmer Penguins](https://allisonhorst.github.io/palmerpenguins/) is an example of a great first dataset to work with. The dataset is clean and clearly labeled. This week's lab will introduce you to using Python to process a csv file.
